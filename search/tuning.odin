...
// Initialize with current tuned defaults.
init_search_params :: proc() {
	params = SearchParams{
		...
		lmr_min_depth          = 4,
		lmr_improving_adj      = -1,
		lmr_history_good_adj   = 0,
		lmr_history_bad_adj    = 1,
		lmr_history_good_thresh= 0,
		lmr_history_bad_thresh = -4045,
		razor_margin           = 186,
		razor_max_depth        = 2,
		delta_pruning_margin   = 554,
		see_prune_threshold    = -60,
		history_max            = 10000,
		history_min            = -10000,
		history_decay_numer    = 9,
		history_decay_denom    = 10,
		continuation_score_div = 1,
